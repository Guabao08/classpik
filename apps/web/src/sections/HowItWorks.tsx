...
const steps = [
  {
    ...
    body: 'Search your school’s course catalog and star the sections you need. No login required — seat counts come from the public schedule.',
  },
  {
    n: '02',
    ...
    <section id="how" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        {steps.map((s) => (
          <SpotlightCard
            key={s.n}
            className="!border-line !bg-white/3 !rounded-2xl p-7"
